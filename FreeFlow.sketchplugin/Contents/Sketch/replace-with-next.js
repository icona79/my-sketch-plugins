var onRun = function(context) {
  ...
  if (selection.layers[0].type === "SymbolInstance"){
    ...
    console.log("previous before: " + e);
    if (e == -1){
      e = arraySymbolsID.length - 1;
    }
    ...
    ui.message("🌈: Done replacing Symbol Instance with next Symbol Instance: "+symbolInstance.name+"! 👏 🚀");
  ...
  if (selection.layers[0].type === "Text" || selection.layers[0].type === "ShapePath"){
    ...
    ui.message("🌈: Replaced Current "+styleType+" Style with next "+styleType+" Style: "+ styleNameArray[styleNameArray.length-1] +"! 👏 🚀");
