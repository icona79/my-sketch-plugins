var onRun = function(context) {
  ...
  var selectionsArtboad = selectedLayers.layers[0].getParentArtboard();
  //var selections = selection.objectEnumerator();

  page = selectionsArtboad;
  ...
  ui.message("🌈: You selected "+ allItems_with_same_type.length +" elements with same name within the same Artboard! 👏 🚀");
