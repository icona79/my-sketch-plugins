var onRun = function(context) {
  ...
  var selectedObjects = document.selectedLayers.layers[0];
      ...
      var tempArtboard = new Artboard({
         name: selectedObjects.name,
         background: { enabled: true, includedInExport: true, color: '#f9f9f9ff' },
       })
      ...
      // tempArtboard.background.enabled = "true"
      // tempArtboard.background.includedInExport = "true"
      // tempArtboard.background.color = '#f9f9f9ff'
